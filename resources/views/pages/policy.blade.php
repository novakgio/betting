  ...
  <div class="container">
     <div class="row text-center intro-title">
           <div class="col-lg-6 col-md-6 col-sm-6 text-left">
             <h1 class="text-white">Our Rules And Terms</h1>
           </div>
           <div class="col-lg-6 col-md-6 col-sm-6 text-right">
             <ul class="page-breadcrumb">
                <li><a href="#"><i class="fa fa-home"></i> Home</a> <i class="fa fa-angle-double-right"></i></li>
                <li><a href="#">pages</a> <i class="fa fa-angle-double-right"></i></li>
                <li><span>Agreement Terms</span> </li>
             </ul>
           </div>
     </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-offset-1 col-md-10">
         <div class="section-title">
           <span>WinnerTips' Rules </span>
           <h2>Get to know our rules</h2>
           <div class="separator"></div>
           <p>In Every Business,There's a breach.something that can destroy the whole business and there's also a little chance [0.001%] that you could lose.we think we have already told you all about us and our risks. now it's your choice to decide where you want to be with us or not. in both way,we don't take any responsibility and whatever you decide, you can't blame us.That's the business,but we will always be with you and support you and help you. Thanks for trying us
   ...
   <div class="row">
    <div class="col-lg-12 col-md-12">
      ...
      <div class="item">
        <div class="testimonial-block text-center">
           <div class="testimonial-image">
             <img class="img-responsive" src="images/testimonial/01.jpg" alt="">
           </div> 
     ...
     <div class="item">
        <div class="testimonial-block text-center">
           <div class="testimonial-image">
             <img class="img-responsive" src="images/testimonial/02.jpg" alt="">
           </div> 
           <div class="testimonial-box">
             <div class="testimonial-avtar">
      ...
      <div class="item">
        <div class="testimonial-block text-center">
           <div class="testimonial-image">
             <img class="img-responsive" src="images/testimonial/03.jpg" alt="">
           </div> 
           <div class="testimonial-box">
             <div class="testimonial-avtar">
      ...
      <div class="item">
        <div class="testimonial-block text-center">
           <div class="testimonial-image">
             <img class="img-responsive" src="images/testimonial/04.jpg" alt="">
           </div> 
           <div class="testimonial-box">
             <div class="testimonial-avtar">
