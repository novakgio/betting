      ...
      <div class="widget">
         <div class="widget-search">
           ...
           <ul class="list-style-none">
             <li><i class="fa fa-star"> </i> Results Found <span class="pull-right">(39)</span></li>
             <li><i class="fa fa-shopping-cart"> </i> Compare Vehicles <span class="pull-right">(10)</span></li>
           </ul>
       </div>
       <div class="clearfix">
         <ul class="list-group">
        ...
        <div class="widget-banner">
          <img class="img-responsive center-block" src="images/banner.jpg" alt="">
       </div>
      </div>
     </div>
                ...
                <div class="car-title">
                 ...
                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero numquam repellendus non voluptate. Harum blanditiis ullam deleniti.</p>
                  ...
                  <div class="price">
                       ...
                       <a class="button red pull-right" href="#">Details</a>
                     </div>
                   <div class="car-list">
